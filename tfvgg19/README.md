...
Note! This tensorflow implementation of VGG 19 was written by github user machrisaa and not me!

For usage of VGG 19, it is crucial to have the vgg19.npy file downloaded---likely in the same directory as vgg19.py.

Changes made by Stefan Ilic and Aryan Mann:
- made a new function in vgg19.py called build2 which adapts the original build method to allow tensorflow variable
input
 
The original code comes with the following README:
